...
- Construir un ETL que permita extraer datos desde la API Open Charge Map, transformarlos y almacenarlos en PostgreSQL, generando una base estructurada que permita futuros análisis sobre infraestructura de electromovilidad en Chile. 
...
- **Conexión:** Punto de carga o cargador disponible en el POI. 


## Desarrollo
Para poder ejecutar el proyecto es necesario tener en consideración los puntos indicados a continuación:
- Creación del entorno.
- Instalar las librerías necesarias.
- Definir las variables de entorno.
- Crear la base de datos de destino en PostgreSQL.
...
### Instalar librerías
Considerar el archivo `requirements.txt` para instalar las librerías necesarias.
...
- `requirements.txt`: Archivo de texto que contiene las librerías externas necesarias para el proyecto.
- `sql`: Carpeta contenedora de los scripts sql necesarios para construir la base de datos en PostgreSQL.
- `src`: Carpeta contenedora de los archivos del proyecto.
    - `api_exploracion.ipynb`: Jupyter Notebook, obtención de los datos, transformaciones y limpiezas exploratorias.
...
- Extracción de datos de referencia:
    - Estaciones de carga y puntos de conexión.
    - Operadores.
...
![ModeloBD](sql/Diagrama_BD_OpenChargeMap.jpg)

Se debe tener en consideración la siguiente equivalencia de datos de la API con el modelo:
...
> **Tipos de estados** <br>
> Estado de una locación o tipo de equipamiento. Indica si esta actualmente operativo. <br>
> API: StatusTypes <br>
> BD: status_types <br>

> **Tipos de suministro** <br>
> Corresponde al tipo de suministro de corriente eléctrica. <br>
> API: CurrentTypes <br>
> BD: supply_types <br>
...
> **Pois** <br>
> Puntos de interés. Estaciones de servicio con puntos de carga EVSE. <br>
> API: poi <br>
> BD: pois <br>
...
El proyecto considera el almacenamiento de los datos utilizando 2 formas distintas, para tener una visión de como trabajar con ambas librerías:
...
## Autoría
Proyecto realizado por Mitzi Sánchez, Ingeniera Informática, Chile.
